module github.com/vaastav/agentic_blueprint/examples/chat/wiring

go 1.23.0

require github.com/vaastav/agentic_blueprint/examples/chat/workflow v0.0.0
...
replace github.com/vaastav/agentic_blueprint/examples/chat/workflow => ../workflow
