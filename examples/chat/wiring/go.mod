module github.com/vaastav/dmas_forge/examples/chat/wiring

go 1.23.0

require github.com/vaastav/dmas_forge/examples/chat/workflow v0.0.0
...
replace github.com/vaastav/dmas_forge/examples/chat/workflow => ../workflow
